...
unlocked to sign the Pavcoin-Qt.app bundle.
...
allowing somebody to distribute a Pavcoin-Qt.app or pavcoin-qt-setup.exe with a valid
...
that the pavcoin-qt.exe file inside the installer had not been tampered with.
