...
#if defined(NDEBUG)
# error "Pavcoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Pavcoin Signed Message:\n";
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // Pavcoin also requires DER encoding of pubkeys
    flags |= SCRIPT_VERIFY_DERKEY;
    // Pavcoin also requires low S in sigs
