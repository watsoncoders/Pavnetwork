...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"pavcoinaddress\"\n"
            "\nReveals the private key corresponding to 'pavcoinaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"pavcoinaddress\"   (string, required) The pavcoin address for the private key\n"
            "\nResult:\n"
