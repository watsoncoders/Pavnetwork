...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s pavcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  pavcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded pavcoin transaction") + "\n" +
              "  pavcoin-tx [options] -create [commands]   " + _("Create hex-encoded pavcoin transaction") + "\n" +
              "\n";
